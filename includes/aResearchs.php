  ...
  <div class="dashboard-container">
    <aside class="sidebar">
      ...
      <ul class="nav-list">
        ...
        <li class="active"><a href="aResearchs.php"><span>📈</span> Research Works</a></li>
    ...
    <main class="main-content">
        ...
        <div>
            <table class="table">
                ...
                <tr height="40">
                    <td style="text-align: center;"><?php echo htmlspecialchars($row['research_id']); ?></td>		
                    <td><?php echo htmlspecialchars($row['title']); ?></td>
                    <td><?php echo mb_strimwidth($row['description'], 0, 50, "..."); ?></td>
                    <td>
                        <a href="Edit_aResearchs.php?research_id=<?php echo urlencode($row['research_id']); ?>" class="btn warning">Edit</a>
                    </td>
                    <td>
                        <a href="Delete_aResearchs.php?research_id=<?php echo urlencode($row['research_id']); ?>" class="btn danger">Delete</a>
                    </td>
                </tr>
                <?php endwhile; ?>
                <?php else: ?>
        ...
        <section class="status-buttons">
            <a href="Add_aResearchs.php" class="btn success">Add new</a> <!-- Sửa lồng thẻ -->
        </section>
    </main>
  </div>
