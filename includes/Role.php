  ...
  <div class="dashboard-container">
    ...
    <main class="main-content">
        ...
        <div>
            <table class="table">
                ...
                <tr height="40">
                    ...
                    <td>
                        <a href="Edit_Role.php?selectedWork_id=<?php echo urlencode($row['selectedWork_id']); ?>" class="btn warning">Edit</a>
                    </td>
                    <td>
                        <a href="Delete_Role.php?selectedWork_id=<?php echo urlencode($row['selectedWork_id']); ?>" class="btn danger">Delete</a>
                    </td>
                </tr>
                <?php endwhile; ?>
                <?php else: ?>
        ...
        <section class="status-buttons">
            <a href="Add_Role.php" class="btn success">Add new</a> <!-- Sửa lồng thẻ -->
        </section>
    </main>
  </div>
