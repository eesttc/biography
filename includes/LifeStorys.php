  ...
  <div class="dashboard-container">
    <aside class="sidebar">
      ...
      <ul class="nav-list">
        ...
        <li class="active"><a href="LifeStorys.php"><span>📈</span> Life Story</a></li>
        ...
        <div>
            <table class="table"> 
                ...
                <tr height="40">
                    ...
                    <td>
                        <a href="Edit_LifeStorys.php?biography_id=<?php echo urlencode($row['biography_id']); ?>" class="btn warning">Edit</a>
                    </td>
                    <td>    
                        <a href="Delete_LifeStorys.php?biography_id=<?php echo urlencode($row['biography_id']); ?>" class="btn danger">Delete</a>
                    </td>
                </tr>
                <?php endwhile; ?>
                <?php else: ?>
            ...
            <section class="status-buttons">
              <a href="Add_LifeStorys.php" class="btn success">Add new</a>
            </section>
        </div>
    </main>
  </div>
