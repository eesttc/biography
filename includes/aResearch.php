  ...
  <div class="dashboard-container">
    <aside class="sidebar">
      ...
      <ul class="nav-list">
        ...
        <li class="active"><a href="aResearch.php"><span>📈</span> Research Works</a></li>
    ...
    <main class="main-content">
        ...
        <div>
            <table class="table">
                ...
                <tr height="40">
                    ...
                    <td>
                        <a href="Edit_aResearch.php?research_id=<?php echo urlencode($row['research_id']); ?>" class="btn warning">Edit</a>
                    </td>
                    <td>
                        <a href="Delete_aResearch.php?research_id=<?php echo urlencode($row['research_id']); ?>" class="btn danger">Delete</a>
                    </td>
                </tr>
                <?php endwhile; ?>
                <?php else: ?>
        ...
        <section class="status-buttons">
            <a href="Add_aResearch.php" class="btn success">Add new</a> <!-- Sửa lồng thẻ -->
        </section>
    </main>
  </div>
