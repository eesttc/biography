        ...
        <div>
            <table class="table"> 
                ...
                <tr height="40">
                    ...
                    <td>
                        <a href="Edit_Indexs.php?person_id=<?php echo urlencode($row['person_id']); ?>" class="btn warning">Edit</a>
                    </td>
                    <td>    
                        <a href="Delete_Indexs.php?person_id=<?php echo urlencode($row['person_id']); ?>" class="btn danger">Delete</a>
                    </td>
                </tr>
                <?php endwhile; ?>
                <?php else: ?>
            ...
            <section class="status-buttons">
              <a href="Add_Indexs.php" class="btn success">Add new</a>
            </section>
        </div>
        ...
        <div>
            <table class="table"> 
                ...
                <tr height="40">
                    ...
                    <td>
                        <a href="Visits.php?visit_id=<?php echo urlencode($row['visit_id']); ?>" class="btn warning">Full</a>
                    </td>
                    <td>    
                        <a href="Delete_Visits.php?visit_id=<?php echo urlencode($row['visit_id']); ?>" class="btn danger">Delete</a>
                    </td>
                </tr>
                <?php endwhile; ?>
                <?php else: ?>
